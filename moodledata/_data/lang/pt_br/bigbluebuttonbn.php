...
$string['completionengagement_desc'] = 'O estudante deve participar de atividades durante a reunião';
$string['completionengagementchats'] = 'Chats';
$string['completionengagementchats_desc'] = 'Participar de {$a} chat(s).';
$string['completionengagementchats_event_desc'] = '{$a} chat(s) criado(s)';
$string['completionengagementemojis'] = 'Emojis';
$string['completionengagementemojis_desc'] = 'Alterar {$a} vezes seus emoji(s).';
$string['completionengagementemojis_event_desc'] = 'Emoji(s) alterado(s) {$a} vez(es) .';
...
$string['completionengagementpollvotes_desc'] = 'Votar {$a} vez(es) nas enquetes.';
$string['completionengagementpollvotes_event_desc'] = 'Respondeu a enquete com {$a} voto(s)';
...
$string['completionengagementtalks_desc'] = 'Conversar {$a} vez(es)';
...
$string['config_checksum_algorithm'] = 'Algoritmo de Checksum BigBlueButton';
$string['config_checksum_algorithm_description'] = 'O algoritmo de checksum do seu servidor BigBlueButton.
(SHA1 garante compatibilidade com versões de servidor mais antigas, mas é menos seguro, enquanto SHA512 é compatível com FIPS 140-2.)';
...
$string['config_extended_capabilities'] = 'Permissões extendidadas';
...
$string['config_meetingevents_enabled'] = 'Gravar sessões ao vivo';
$string['config_meetingevents_enabled_description'] = 'Se habilitado, as sessões ao vivo serão processadas após o término da sessão. Esse recurso é necessário para a conclusão da atividade e só funcionará se o servidor BigBlueButton for capaz de processar scripts post_events.';
...
$string['config_preuploadpresentation'] = 'Apresentação do pré-carregamento';
$string['config_preuploadpresentation_description'] = 'Essas configurações ativam ou desativam as opções na interface do usuário e também definem valores padrão para essas opções. O recurso funciona apenas se o servidor BigBlueButton estiver acessível para o Moodle.';
...
$string['config_recording_all_from_start_default_description'] = 'A configuração \'Iniciar a gravação desde o início\' deve ser habilitada por padrão ao adicionar uma nova sala BigBlueButton?';
$string['config_recording_all_from_start_editable'] = 'Gravar tudo desde o início pode ser editado';
$string['config_recording_all_from_start_editable_description'] = '\'Iniciar a gravação desde o início\' deve ser editável nas configurações da atividade BigBlueButton?';
...
$string['config_recording_editable_description'] = '\'A sessão pode ser gravada\' deve ser editável nas configurações da atividade BigBlueButton?';
...
$string['config_recording_hide_button_editable_description'] = '\'Ocultar botão de gravação\' deve ser editável nas configurações da atividade BigBlueButton?';
...
$string['config_recordingready_enabled'] = 'Enviar notificação quando uma gravação estiver disponível';
$string['config_recordingready_enabled_description'] = 'Habilite o plugin para enviar notificações quando a gravação estiver disponível. (Essa funcionalidade necessita que o script post_publish_recording_ready_callback esteja habilitado no servidor BigBlueButton)';
...
$string['config_scheduled_description'] = 'Essas configurações definem um comportamento padrão para as sessões agendadas.';
...
$string['config_userlimit'] = 'Limite do usuário';
...
$string['config_voicebridge'] = 'Canal de voz';
...
$string['config_voicebridge_editable_description'] = 'O número do canal de voz pode ser atribuído permanentemente a uma sala. Quando atribuído, o número não pode ser usado por nenhuma outra sala.';
$string['config_waitformoderator'] = 'Aguardar o moderador';
...
$string['config_waitformoderator_default_description'] = 'A configuração \'Aguardar o moderador\' deve ser habilitada por padrão ao adicionar uma nova sala BigBlueButton?';
...
$string['config_waitformoderator_editable_description'] = 'Aguardar o moderador\' deve ser editável nas configurações da atividade BigBlueButton?';
$string['config_waitformoderator_ping_interval'] = 'Aguardar o ping do moderador (segundos)';
$string['config_waitformoderator_ping_interval_description'] = 'Com que frequência o servidor deve receber um ping para verificar se o moderador entrou na sala?';
...
$string['email_body_recording_ready_for'] = 'Existe uma gravação pronta para';
$string['email_body_recording_ready_in_course'] = 'no curso';
...
$string['general_error_unable_connect'] = 'Não foi possível conectar. Por favor verifique a url do servidor BigBlueButton e veja se o servidor BigBlueButton está em execução.
Detalhes: {$a}';
$string['index_confirm_end'] = 'Você quer finalizar a sessão?';
$string['index_disabled'] = 'desabilitado';
$string['index_enabled'] = 'habilitado';
$string['index_ending'] = 'Finalizando a sessão ... por favor aguarde';
...
$string['index_error_forciblyended'] = 'Não é possível participar desta reunião porque ela foi finalizada manualmente.';
$string['index_error_noinstances'] = 'Não há instâncias de salas BigBlueButton';
$string['index_error_unable_display'] = 'Não é possível mostrar as sessões. Por favor verifique o url do servidor BigBlueButton e verifique se ele está em execução.';
...
$string['mod_form_field_instanceprofiles_help'] = 'Se uma sessão for gravada, selecione \'Sala com gravações\', caso contrário, \'Apenas sala\'. Após a gravação de uma sessão, se não houver mais sessões, selecione \'Apenas gravações\'.';
...
$string['privacy:metadata:bigbluebuttonbn_logs:timecreated'] = 'A hora que o log foi criado.';
...
$string['report_join_info'] = 'Entrou na sala {$a} vez(es)';
...
$string['view_error_no_group'] = 'Não existem grupos. Você precisa criar alguns grupos antes de tentar entrar na sessão.';
$string['view_error_no_group_student'] = 'Você não foi inscrito em um grupo. Por favor entre em contato com seu professor.';
$string['view_error_no_group_teacher'] = 'Não existem grupos. Você precisa criar alguns grupos.';
$string['view_error_unable_join'] = 'Não foi possível entrar na reunião. Por favor verifique se o URL do servidor BigBlueButton está correto e se o servidor está ativo.';
$string['view_error_unable_join_student'] = 'Não foi possível a conexão com o servidor BigBlueButton.';
...
$string['view_message_recordings_disabled'] = 'As gravações foram desabilitadas neste servidor. Atividades BigBlueButton do tipo \'Somente gravação\' não podem ser usadas.';
...
$string['view_recording_publish_link_deleted'] = 'Este link não pode ser republicado porque a gravação original não existe no servidor BigBlueButton atual. O link deve ser removido.';
$string['view_recording_publish_link_not_published'] = 'Este link não pode ser re-publicado porque a gravação original não está publicada';
...
$string['view_recording_unprotect_link_deleted'] = 'Este link não pode ser desprotegido porque a gravação original não existe no servidor BigBlueButton atual. O link deve ser removido.';
...
$string['view_warning_default_server'] = 'Este site está usando um <a href="https://bigbluebutton.org/free-bigbluebutton-service-for-moodle/" target="_blank">serviço BigBlueButton gratuito para Moodle (abre em uma nova janela)</a> fornecido pela Blindside Networks com as seguintes restrições:
<ol>
<li>A duração máxima de cada sessão é de 60 minutos</li>
<li>O número máximo de usuários simultâneos por sessão é 25</li>
<li>As gravações expiram após sete (7) dias e não podem ser baixadas após este prazo</li>
