...
$string['xmlrpcmaharaenabled'] = 'Foi detectado que o Mahara ePortfolio está habilitado em seu site. Este recurso depende da extensão PHP XML-RPC que não é mais mantida pelo PHP.';
$string['xmlrpcmnetenabled'] = 'Foi detectado que a Rede Moodle está habilitada em seu site. Este recurso depende da extensão PHP XML-RPC que não é mais mantida pelo PHP.';
