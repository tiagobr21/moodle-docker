...
$string['alternative_hosts_desc'] = 'Com esta configuração, você pode controlar se a opção de escolher hosts alternativos é mostrada aos usuários nas configurações da instância de atividade ou não. Dois tipos de widgets estão disponíveis: Um campo de entrada simples que aceita endereços de email separados por vírgulas. E um seletor de usuários com preenchimento automático que facilita a seleção de usuários que estão inscritos no curso, têm uma conta Zoom e um papel de {$a->roles}. Hosts alternativos que podem ter sido definidos pelo professor diretamente no Zoom, mas não podem ser selecionados no seletor de usuário do Moodle ainda são mostrados na página de visão geral da atividade e também são preservados quando uma reunião é atualizada no Moodle.';
...
$string['err_downloadicalrecurringempty'] = 'Não é possível baixar o arquivo iCal desta reunião do Zoom, pois não contém ao menos uma única ocorrência.';
$string['err_downloadicalrecurringnofixed'] = 'Não é possível baixar o arquivo iCal desta reunião do Zoom, pois é uma reunião recorrente sem horário fixo.';
